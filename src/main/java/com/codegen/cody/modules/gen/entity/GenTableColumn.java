 ...
 */
package com.codegen.cody.modules.gen.entity;
...
public class GenTableColumn extends DataEntity<GenTableColumn> {
	...
	private String referenceTable;//关联的表
	private String referenceEntity;//关联的实体
	private String referenceField;//关联字段|显示字段
