 ...
 */
package com.codegen.cody.modules.gen.web;
...
import com.codegen.cody.modules.gen.service.GenSchemeService;
import com.codegen.cody.modules.gen.service.GenTableService;
import com.codegen.cody.modules.gen.util.GenUtils;
...
public class GenSchemeController extends BaseController {
	...
	public String form(GenScheme genScheme, Model model) {
		if (StringUtils.isBlank(genScheme.getPackageName())){
			String projectPath = Global.getConfig("basePackageName");
			genScheme.setPackageName(projectPath);
		}
...
//		}
	...
	public String save(GenScheme genScheme, Model model, RedirectAttributes redirectAttributes) {
		...
		User user = UserUtils.getUser();
		genScheme.setFunctionAuthor(user.getName());
