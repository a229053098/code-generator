 ...
 */
package com.codegen.cody.modules.gen.util;
...
import com.codegen.cody.common.mapper.JaxbMapper;
import com.codegen.cody.common.utils.DateUtils;
import com.codegen.cody.common.utils.FileUtils;
import com.codegen.cody.common.utils.FreeMarkers;
import com.codegen.cody.common.utils.StringUtils;
import com.codegen.cody.modules.gen.entity.GenCategory;
import com.codegen.cody.modules.gen.entity.GenConfig;
...
import com.codegen.cody.modules.sys.entity.User;
		...
		for (GenTableColumn column : genTable.getColumnList()){
			...
			if (StringUtils.startsWithIgnoreCase(column.getJdbcType(), "decimal")) {
				...
				if (ss != null && ss.length == 2 && Integer.parseInt(ss[1])>0){
					if(StringUtils.startsWithIgnoreCase(column.getJdbcType(), "Double")){
			...
			if (!StringUtils.equalsIgnoreCase(column.getName(), "id")
					...
					&& !StringUtils.equalsIgnoreCase(column.getName(), "add_time")
					&& !StringUtils.equalsIgnoreCase(column.getName(), "create_user")
					...
					&& !StringUtils.equalsIgnoreCase(column.getName(), "update_user")
					&& !StringUtils.equalsIgnoreCase(column.getName(), "op_id")
					&& !StringUtils.equalsIgnoreCase(column.getName(), "op_name")
			...
			// 创建者、更新者，这里注释，已经不是cody那种实体关联的形式了
...
//		}
	...
	public static Map<String, Object> getDataModel(GenScheme genScheme){
		...
		model.put("PackageName", StringUtils.uncapitalize(genScheme.getPackageName()));
		...
		model.put("excel",StringUtils.capitalize(genScheme.getGenTable().getExportExcel()));
		model.put("defaultSortField",genScheme.getGenTable().getDefaultSortField());
