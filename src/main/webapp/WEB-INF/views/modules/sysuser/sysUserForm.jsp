...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sysuser/sysUser/">系统用户列表</a></li>
		<li class="active"><a href="${ctx}/sysuser/sysUser/form?id=${sysUser.id}">系统用户<shiro:hasPermission name="sysuser:sysUser:edit">${not empty sysUser.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="sysuser:sysUser:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="sysUser" action="${ctx}/sysuser/sysUser/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="sysuser:sysUser:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
