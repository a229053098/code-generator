...
<body>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead><tr><th class="sort-column name">表名</th><th>说明</th><th class="sort-column class_name">类名</th>
		<th class="sort-column parent_table">父表</th><th>修改时间</th>
		...
		<c:forEach items="${page.list}" var="genTable">
			<tr>
				...
				<td><fmt:formatDate value="${genTable.updateDate}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
