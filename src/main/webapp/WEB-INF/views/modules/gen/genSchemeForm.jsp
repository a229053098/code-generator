	...
	<form:form id="inputForm" modelAttribute="genScheme" action="${ctx}/gen/genScheme/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<span class="help-inline">建议模块包：com.qipa</span>
			</div>
		</div>
		<%--<div class="control-group">--%>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="functionName" htmlEscape="false" maxlength="500" class="required input-xlarge"/>
				<span class="help-inline">用于面包屑导航，比如：首页 > 系统配置 > 用户列表  这里的系统配置</span>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				...
				<span class="help-inline">用于面包屑导航，比如：首页 > 系统配置 > 用户列表  这里的用户列表</span>
			</div>
		</div>
		<%--<div class="control-group">--%>
